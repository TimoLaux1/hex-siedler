...
const englishUi: Record<string, string> = {
  ...
  "Goldmine für alle freigeschaltet": "Gold mine unlocked for everyone", "Die Goldmine wurde für alle Spieler freigeschaltet. Eigene Siedlungen, die an eine Wüste grenzen, können zur Goldmine ausgebaut werden. Die Würfelzahl 7 gibt dem Besitzer der Goldmine einen beliebigen Rohstoff.": "The gold mine has been unlocked for all players. Your own settlements bordering a desert can be upgraded to a gold mine. A roll of 7 gives the gold mine's owner one resource of their choice.",
...
const klausCards: Record<KlausKind, { title: string; face: string; description: string; tone: string }> = {
  ...
  angry: { title: "Böser Klaus", face: "😠", description: "Versetzt den Räuber und erhält einen Ritter.", tone: "red" },
